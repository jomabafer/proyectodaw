<?php
	...
	$sql ="INSERT INTO `megustaFoto` (`idUsuario`, `idFoto`) VALUES ('".$usuario."','".$publicacion."')";
	try{
		...
		/*if($idUsuarioEncontrado){
			...
			if($resultadoMeGusta){
				...
				$sql ="INSERT INTO `notificacionMeGusta` (`idUsuario`, `idFoto`) VALUES (".$usuario.",".$publicacion.")";
				try{
					$resultadoMeGusta = $consulta->conn->query($sql);
					//$resultadoMeGusta = $consulta->conn->query($sql);
					/*if($idUsuarioEncontrado){
