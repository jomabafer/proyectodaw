...
<div id="datosPersonales">
	...
	<!--</div> -->
				...
				}//Aquí debería haber un div que englobe el perfil y las publicaciones
				?>
				<div class='row'>
				<?php
				if($autorizacionPublicaciones==true){
					...
					//echo '<div class="product-feed-tab current col-md-8" id="feed-dd"><div class="posts-section"><div class="post-bar"><div class="job_descp"><h3>Este perfil sólo muestra sus publicaciones a sus amistades.</h3></div></div></div></div></div></div>';
					echo '<div id="desconocidxsNo" class="col-md-8"><div class="post-bar"><div class="job_descp"><h3>Este perfil sólo muestra sus publicaciones a sus amistades.</h3></div></div></div>';
				}
				//Aquí seguiría el div del perfil
				?>
			...
			<!---->
				...
				<?php
				//Aqui acabaría el div que engloba el perfil y las publicaciones
			}
